...
- Improved mobile spacing, navigation and touch targets
...
`nassreddine-net.github.io`

Then enable GitHub Pages from `main` and `/ (root)`. The site should be available at:

`https://nassreddine-net.github.io/`

## is-a.dev
After the root site is working, submit `domains/nassreddine.json` to the official register repository. The CNAME target should be the hostname only:
